...
<div class="container mt-5">
   <div class="card text-center bg-success-subtle">
    ...
    <div class="d-flex flex-column flex-md-row pt-5 gap-5 align-items-center">
        <img src="https://upload.wikimedia.org/wikipedia/id/9/9e/Logo_SMK_Negeri_4_Tasikmalaya.png" width="20%" alt="">
        <table class="table table-bordered">
            <tbody>
                <tr>
                    <th>Nama Sekolah</th>
                    <td>SMKN 4 Kota Tasikmalaya</td>
                </tr>
                <tr>
                    <th>NPSN</th>
                    <td>20276063</td>
